...
function Skeleton() {
  return (
    <div role="status" className="w-full rounded animate-pulse">
      <div className="w-full bg-slate-300  rounded-2xl shadow dark:bg-gray-800 dark:border-gray-700">
        <svg
          className="h-60 text-gray-200 dark:text-gray-600 mb-6 mt-6 px-8 pt-4 rounded-t-lg w-full"
          aria-hidden="true"
        ...
        <div className="px-5 pb-5">
          ...
          <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-2 w-60" />

          <div className="flex items-center justify-between">
            <span className="text-3xl font-mediu text-gray-900 dark:text-white">
              <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-2 w-40" />
            </span>
            <svg
